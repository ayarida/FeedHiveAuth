...
function calendarJs(elementOrId, options, searchOptions) {
    ...
    function isSideMenuAvailable() {
        return (
            _options.showSideMenuDays ||
            _options.showSideMenuEventTypes ||
            _options.showSideMenuGroups ||
            _options.showSideMenuWorkingDays ||
            _options.showSideMenuWeekendDays
        );
    }
    ...
    function updateDatePickerInputValueDisplay(date) {
        _element_Mode_DatePicker_Input.value = getCustomFormattedDateText(
            _options.datePickerSelectedDateFormat,
            date
        );
    ...
    function isDateValidForDatePicker(newDate) {
        ...
        if (_options.minimumDatePickerDate !== null) {
            newDateAllowed = isDateSmallerOrEqualToDate(
                _options.minimumDatePickerDate,
                newDate
            );
        }
        ...
        if (newDateAllowed && _options.maximumDatePickerDate !== null) {
            newDateAllowed = isDateSmallerOrEqualToDate(
                newDate,
                _options.maximumDatePickerDate
            );
        }
    ...
    function buildFullDayViewWorkingHours() {
        if (
            ...
            _options.workingHoursStart !== _options.workingHoursEnd
        ) {
        ...
        if (
            ...
            if (!fireCustomTrigger("onFullDayEventRender", event, eventDetails)) {
                ...
                if (
                    ...
                    _options.showAllDayEventDetailsInFullDayView
                ) {
                    var startTime = createElement("div", "date");
                    event.appendChild(startTime);
    ...
    function buildFullWeekViewEvent(
        ...
        if (
            ...
            if (_element_View_FullWeek_Contents_SmallestEventTop === 0) {
                ...
                _element_View_FullWeek_Contents_SmallestEventTop = Math.min(
        ...
        while (fromDate < weekEndDate) {
            ...
            if (_options.visibleDays.indexOf(weekDayNumber) > -1) {
                children[childrenIndex].innerHTML +=
                    _string.space + fromDate.getDate() + "/" + (fromDate.getMonth() + 1);
                childrenIndex++;
            }
    ...
    function buildFullMonthViewPinUpImage() {
        if (
            ...
            if (_options.pinUpViewImageUrls.length > 0) {
                ...
                if (
                    _element_View_FullMonth_PinUp_ImageIndex ===
                    _options.pinUpViewImageUrls.length
                ) {
                    _element_View_FullMonth_PinUp_ImageIndex = 0;
                }
            }
                ...
                if (_options.visibleDays.indexOf(dayNumber) > -1) {
                    var columnDataNumber = rowIndex * 7 + (columnDataIndex + 1),
                        columnData = createElement(
                            "div",
                            getCellName(_options.allowEventScrollingOnMainDisplay)
                        );
    ...
    function buildFullMonthViewYearDropDown(container) {
        ...
        _element_View_FullMonth_TitleBar_YearSelector = createElement(
            "div",
            _options.showMonthButtonsInYearDropDownMenu
                ? "years-drop-down"
    ...
    function setFullMonthViewYearDropDownButtonText() {
        _element_View_FullMonth_TitleBar_YearSelector_DropDown_Text.innerText =
            getCustomFormattedDateText(
                _options.monthTitleBarDateFormat,
                _calendar_CurrentDate
            );
    }
    ...
    function buildDay(
        ...
        if (dayElement !== null) {
            ...
            if (
                includeMonthName &&
                _options.showPreviousNextMonthNamesInMainDisplay
            ) {
                createSpanElement(
                    dayElement,
        ...
        if (
            ...
            if (elementDay !== null) {
                ...
                if (!_element_Mode_DatePicker_Enabled) {
                    ...
                    if (
                        events.length < _options.maximumEventsPerDayDisplay ||
                        _options.maximumEventsPerDayDisplay <= 0 ||
                        _options.useOnlyDotEventsForMainDisplay
                    ) {
                        var event = createElement("div", "event"),
                            eventRendered = false;
                        ...
                        setEventClassesAndColors(
                            ...
                            _options.applyCssToEventsNotInCurrentMonth
                        );
                        setEventCustomTriggers(event, eventDetails, editEventDate);
    ...
    function buildTimelineViewEvent(timelineRowItems, eventDetails) {
        ...
        if (_element_View_Timeline_Contents_SmallestEventLeft === 0) {
            ...
            _element_View_Timeline_Contents_SmallestEventLeft = Math.min(
        ...
        if (_element_View_Timeline_Contents_SmallestEventTop === 0) {
            ...
            _element_View_Timeline_Contents_SmallestEventTop = Math.min(
                _element_View_Timeline_Contents_SmallestEventTop,
                timelineRowItems.offsetTop
            );
        }
    ...
    function buildConfigurationDialog() {
        if (
            ...
            _element_Dialog_Configuration_Display_EnableDayNamesInMainDisplay =
                buildCheckBox(
                    _element_Dialog_Configuration_Display,
                    _options.enableDayNameHeadersInMainDisplayText
                )[0];
    ...
    function configurationDialogEvent_OK() {
        ...
        _options.showDayNamesInMainDisplay =
            _element_Dialog_Configuration_Display_EnableDayNamesInMainDisplay.checked;
    ...
    function isTimeArrowVisible(date, elementView) {
        return (
            isDateToday(date) &&
            isViewVisible(elementView) &&
            _options.showTimelineArrowsOnViews
        );
    }
    ...
    function getExportDownloadFilename(extension) {
        ...
        return (
            _options.exportStartFilename + datePart + "_" + timePart + "." + extension
        );
    }
    ...
    this.setVisibleEventTypes = function (ids, triggerEvent) {
        if (isDefinedArray(ids) && !_element_Mode_DatePicker_Enabled) {
            ...
            for (var idIndex = 0; idIndex < idsLength; idIndex++) {
                if (
                    _options_Configuration.visibleEventTypes.indexOf(ids[idIndex]) === -1
                ) {
    ...
    function buildDefaultOptions(newOptions) {
        ...
        _options.maximumEventsPerDayDisplay = getDefaultNumber(
            _options.maximumEventsPerDayDisplay,
            3
        );
        ...
        _options.showTimesInMainCalendarEvents = getDefaultBoolean(
            _options.showTimesInMainCalendarEvents,
            false
        );
        ...
        _options.showAllDayEventDetailsInFullDayView = getDefaultBoolean(
            _options.showAllDayEventDetailsInFullDayView,
            false
        );
        _options.showWeekNumbersInTitles = getDefaultBoolean(
            _options.showWeekNumbersInTitles,
            false
        );
        _options.showTimelineArrowsOnViews = getDefaultBoolean(
            _options.showTimelineArrowsOnViews,
            true
        );
        ...
        _options.showPreviousNextMonthNamesInMainDisplay = getDefaultBoolean(
            _options.showPreviousNextMonthNamesInMainDisplay,
            true
        );
        _options.showDayNamesInMainDisplay = getDefaultBoolean(
            _options.showDayNamesInMainDisplay,
            true
        );
        ...
        _options.useOnlyDotEventsForMainDisplay = getDefaultBoolean(
            _options.useOnlyDotEventsForMainDisplay,
            false
        );
        ...
        _options.showExtraToolbarButtons = getDefaultBoolean(
            _options.showExtraToolbarButtons,
            true
        );
        ...
        _options.minimumDatePickerDate = getDefaultDate(
            _options.minimumDatePickerDate,
            null
        );
        _options.maximumDatePickerDate = getDefaultDate(
            _options.maximumDatePickerDate,
            null
        );
        ...
        _options.datePickerSelectedDateFormat = getDefaultString(
            _options.datePickerSelectedDateFormat,
            "{d}{o} {mmmm} {yyyy}"
        );
        ...
        _options.applyCssToEventsNotInCurrentMonth = getDefaultBoolean(
            _options.applyCssToEventsNotInCurrentMonth,
            true
        );
        ...
        _options.addYearButtonsOnMainDisplay = getDefaultBoolean(
            _options.addYearButtonsOnMainDisplay,
            false
        );
        ...
        _options.monthTitleBarDateFormat = getDefaultString(
            _options.monthTitleBarDateFormat,
            "{mmmm} {yyyy}"
        );
        ...
        _options.showMonthButtonsInYearDropDownMenu = getDefaultBoolean(
            _options.showMonthButtonsInYearDropDownMenu,
            true
        );
        _options.showSideMenuDays = getDefaultBoolean(
            _options.showSideMenuDays,
            true
        );
        _options.showSideMenuGroups = getDefaultBoolean(
            _options.showSideMenuGroups,
            true
        );
        _options.showSideMenuEventTypes = getDefaultBoolean(
            _options.showSideMenuEventTypes,
            true
        );
        _options.showSideMenuWorkingDays = getDefaultBoolean(
            _options.showSideMenuWorkingDays,
            true
        );
        _options.showSideMenuWeekendDays = getDefaultBoolean(
            _options.showSideMenuWeekendDays,
            true
        );
        ...
        _options.workingHoursStart = getDefaultString(
        ...
        _options.isPinUpViewEnabled = getDefaultBoolean(
            _options.isPinUpViewEnabled,
            false
        );
        _options.pinUpViewImageUrls = getDefaultArray(
            _options.pinUpViewImageUrls,
            []
        );
    ...
    function setTranslationStringOptions() {
        ...
        _options.enableDayNameHeadersInMainDisplayText = getDefaultString(
            _options.enableDayNameHeadersInMainDisplayText,
            "Enable day name headers in the main display"
        );
