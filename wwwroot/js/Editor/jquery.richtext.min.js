        ...
        $.fn.richText = function (options) {
            ...
            var $editor,
                ...
                $btnBold = $("<a />", {
                    ...
                    html: '<span><iconify-icon icon="icon-park:text-bold"></iconify-icon></span>',
                }),
                $btnItalic = $("<a />", {
                    class: "richText-btn",
                    "data-command": "italic",
                ...
                $btnLeftAlign = $("<a />", {
                    ...
                    html: '<span class="bi bi-justify-left"></span>',
                }),
                $btnCenterAlign = $("<a />", {
                    class: "richText-btn",
                    "data-command": "justifyCenter",
                    title: settings.translations.alignCenter,
                    html: '<span class="bi bi-align-center"></span>',
                }),
                $btnRightAlign = $("<a />", {
                    class: "richText-btn",
                    "data-command": "justifyRight",
                    title: settings.translations.alignRight,
                    html: '<span class="bi bi-text-right"></span>',
                }),
                $btnOL = $("<a />", {
                    class: "richText-btn",
                    "data-command": "insertOrderedList",
                    title: settings.translations.addOrderedList,
                    html: '<span class="i bi-list-ol"></span>',
                }),
                $btnUL = $("<a />", {
                    class: "richText-btn",
                ...
                $btnFont = $("<a />", {
                    ...
                    html: '<span class="bi bi-fonts"></span>',
                }),
                $btnFontColor = $("<a />", {
                    class: "richText-btn",
                    title: settings.translations.addFontColor,
                    html: '<span class="bi bi-palette"></span>',
                }),
                ...
                $btnFontSize = $("<a />", {
                    ...
                    html: '<spam><iconify-icon icon="ant-design:font-size-outlined"></iconify-icon> </span>',
                }),
                $btnImageUpload = $("<a />", {
                    class: "richText-btn",
                    title: settings.translations.addImage,
                    html: '<span class="bi bi-images"></span>',
                }),
                $btnVideoEmbed = $("<a />", {
                    class: "richText-btn",
                ...
                $btnFileUpload = $("<a />", {
                    ...
                    html: '<span class="bi bi-file-earmark-text"></span>',
                }),
                $btnURLs = $("<a />", {
                    class: "richText-btn",
                    title: settings.translations.addURL,
                    html: '<span class="bi bi-link-45deg"></span>',
                }),
                $btnTable = $("<a />", {
                    class: "richText-btn",
                ...
                $btnCode = $("<a />", {
                    ...
                    html: '<span class="bi bi-code-slash"></span>',
                }),
                $btnSave = $("<a />", {
                    class: "save-btn",
                    "data-command": "toggleSave",
                    title: settings.translations.save,
                    html: '<span class="bi bi-floppy"></span>',
                });
            ...
            function init() {
                ...
                if (maxlength > 0) {
                    ...
                    $editor
                        ...
                        .before(
                            $("<a />", { class: "richText-length", text: "0/" + maxlength })
                        );
